...
class refund_Test extends SchemaTestCase {

	function __construct() {
		parent::__construct('refund');
		$this->jsonData = $this->fixture('refund.json');
	}
	...
	function testFixtureShouldValidate() {
		$this->assertValid();
		$this->assertEqual('refund', $this->trx->transaction_type);
	}
	...
	function testTypeWrong() {
		$this->trx->transaction_type = 'capture';
		$this->assertNotValid();
	}

...
class referenced_fund_transfer_Test extends SchemaTestCase {

	function __construct() {
		parent::__construct('referenced_fund_transfer');
		$this->jsonData = $this->fixture('referenced_fund_transfer.json');
	}
	...
	function testFixtureShouldValidate() {
		$this->assertValid();
		$this->assertEqual('referenced_fund_transfer', $this->trx->transaction_type);
	}
	...
	function testTypeWrong() {
		$this->trx->transaction_type = 'void';
		$this->assertNotValid();
	}
